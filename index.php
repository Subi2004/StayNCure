        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.html" class="navbar-brand p-0">
                    ...
                    <img src="img\physioSchool_logo.jpeg" alt="Logo" class="Logo">
                </a>
                ...
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            <h5 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">stayncurephysioschool</h5>
                            <h1 class="display-1 text-capitalize text-white mb-4">Best Solution For Painful Life</h1>
                            <p class="mb-5 fs-5">StayNcure is a leading neurorehabilitation centre that provides holistic and innovative treatments to patients who suffer from neural diseases, accidental brain injuries and trauma, Parkinson’s disease and stroke.<br>

Vision: Enhancing and enlightening the lives<br>

Mission: To provide to the individual and family, with the skills to attain the highest possible level of independence<br>
                            </p>
                ...
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            ...
                            <h1 class="display-1 text-capitalize text-white mb-4">Best Solution For Painful Life</h1>
                            <p class="mb-5 fs-5 animated slideInDown">StayNcure is a leading neurorehabilitation centre that provides holistic and innovative treatments to patients who suffer from neural diseases, accidental brain injuries and trauma, Parkinson’s disease and stroke.<br>
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Massage therapy relaxes muscles, relieves stress, and boosts circulation, promoting overall well-being through skilled manipulation of soft tissues.</p>
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Restoring physical fitness and enhancing a patient’s mobility and bodily functions through state of the art treatment is a major part of our physiotherapy department. Physiotherapy helps through physical rehabilitation, injury prevention, and health and fitness.</p>
                                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>
                                </div>
                            </div>
                        </div>
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Heat therapy increases blood flow, relaxes muscles, and eases stiffness, offering effective relief for muscle pain and tension.Cold therapy reduces inflammation, numbs sore tissues, and alleviates acute pain, making it beneficial for treating injuries and managing swelling.
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Chiropractic therapy restores spinal alignment and improves joint function to alleviate pain, enhance mobility, and support overall wellness through non-invasive manual manipulation techniques.</p>
                                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>
                                </div>
                            </div>
                        </div>
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Work injuries can range from strains and sprains to repetitive motion injuries and falls, impacting productivity and well-being. Prompt assessment and treatment are crucial to facilitate recovery and prevent long-term complications, ensuring a safe return to work.</p>
                                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>
                                </div>
                            </div>
                        </div>
                           ...
                           <div class="service-img rounded-top">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Spot injuries, such as muscle strains or joint sprains, occur suddenly and can be caused by physical exertion or accidents. Immediate attention and appropriate treatment help minimize pain, prevent further damage, and promote swift recovery for optimal healing.</p>
                                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>
                                </div>
                            </div>
                        </div>
